...
ggplot(data= recipe3_predictions_reg, mapping= aes(x = sale_price, y = pred)) +
...
#average total_bath= 2.44--> 2 and half
#sd total_bath= 0.941 --> 1 more bath
#4.83% sale increase in percentage
